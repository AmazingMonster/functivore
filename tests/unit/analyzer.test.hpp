...
static_assert
(std::same_as<
    Analyzer<decltype(fun_1)>::parameter_types,
    Capsule<int, double>
>);
...
static_assert
(! std::same_as<
    Analyzer<decltype(fun_2)>::parameter_types,
...
static_assert
(! std::same_as<
    Analyzer<decltype(fun_3)>::parameter_types,
    Capsule<int const, double&>
>);
...
static_assert
(! std::same_as<
    Analyzer<decltype(FunP_0)>::parameter_types,
    Capsule<int const, double>
>);
...
static_assert
(! std::same_as<
    Analyzer<decltype(FunP_1)>::parameter_types,
    Capsule<int const, double>
>);
...
static_assert
(! std::same_as<
    Analyzer<decltype(FunP_2)>::parameter_types,
    Capsule<int const, double>
>);
...
static_assert
(! std::same_as<
    Analyzer<decltype(FunP_3)>::parameter_types,
    Capsule<int const, double&>
>);
...
static_assert
(! std::same_as<
    Analyzer<decltype(FunAddr_0)>::parameter_types,
    Capsule<int const, double>
>);
...
static_assert
(! std::same_as<
    Analyzer<decltype(FunAddr_1)>::parameter_types,
    Capsule<int const, double>
>);
...
static_assert
(! std::same_as<
    Analyzer<decltype(FunAddr_2)>::parameter_types,
    Capsule<int const, double>
>);
...
static_assert
(! std::same_as<
    Analyzer<decltype(FunAddr_3)>::parameter_types,
    Capsule<int const, double&>
>);
...
static_assert
(! std::same_as<
    Analyzer<decltype(&Tester::fun_0)>::parameter_types,
    Capsule<int const, double>
>);
...
static_assert
(! std::same_as<
    Analyzer<decltype(&Tester::fun_1)>::parameter_types,
    Capsule<int const, double>
>);
...
static_assert
(! std::same_as<
    Analyzer<decltype(&Tester::fun_2)>::parameter_types,
    Capsule<int const, double>
>);
...
static_assert
(! std::same_as<
    Analyzer<decltype(&Tester::fun_3)>::parameter_types,
    Capsule<int const, double&>
>);
...
static_assert
(! std::same_as<
    Analyzer<decltype(&Tester::gun_0)>::parameter_types,
    Capsule<int const, double&>
>);
...
static_assert
(! std::same_as<
    Analyzer<decltype(&Tester::gun_1)>::parameter_types,
    Capsule<int const, double&>
>);
...
static_assert
(! std::same_as<
    Analyzer<decltype(&Tester::gun_2)>::parameter_types,
    Capsule<int const, double&>
>);
...
static_assert
(! std::same_as<
    Analyzer<decltype(&Tester::gun_3)>::parameter_types,
    Capsule<int const, double&>
>);
...
static_assert
(! std::same_as<
    Analyzer<decltype(&Tester::gun_4)>::parameter_types,
    Capsule<int const, double&>
>);
...
static_assert
(! std::same_as<
    Analyzer<decltype(Lambda_0)>::parameter_types,
    Capsule<int const, double>
>);
...
static_assert
(! std::same_as<
    Analyzer<decltype(Lambda_1)>::parameter_types,
    Capsule<int const, double>
>);
...
static_assert
(! std::same_as<
    Analyzer<decltype(Lambda_2)>::parameter_types,
    Capsule<int const, double>
>);
...
static_assert
(! std::same_as<
    Analyzer<decltype(Lambda_3)>::parameter_types,
    Capsule<int const, double&>
>);
...
static_assert
(! std::same_as<
    Analyzer<decltype(Lambda_4)>::parameter_types,
    Capsule<int const, double&>
>);
